    ...
    <div className=" min-h-screen bg-gray-50">
        ...
        <div className=" mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2">
              <img 
                src="https://www.naukri.com/campus/career-guidance/wp-content/uploads/2023/09/upskilling.png" 
                alt="Learning illustration" 
                className="rounded-e-full shadow-xl max-w-full hover:shadow-blue-400/20 transition-all duration-300"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-indigo-800 to-blue-900">
        <div className="w-full mx-auto text-center">
          <h2 className="text-3xl md:text-4xlfont-bold text-white mb-6">Start Your Learning Journey Today</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/" className="text-gray-400 hover:text-white transition duration-300">About Us</Link></li>
